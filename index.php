...
<head>
  ...
  <title>CV. Surya Perkasa - Index</title>
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Welcome to CV. Surya Perkasa</h1>
      <h2>We are team of developers who can make you websites or mobile apps.</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-5 col-lg-5 pt-5 pt-lg-0">
            ...
            <p data-aos="fade-up">
              Surya Perkasa adalah perusahaan yang bergerak dibidang jasa teknologi informasi yang menyediakan jasa untuk solusi digital bisnis dan organisasi anda.
            </p>
            <p data-aos="fade-up">
              Kami berkomitmen untuk perubahan yang lebih baik untuk kemajuan bangsa dengan implementasi teknologi informasi.
            </p>
...
<!-- 
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/Portfolio_5.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>APP SAFETY BOSOWA</h4>
                <p>App</p>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/Portfolio_1.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>LAUTAN MAMASA</h4>
                <p>Web</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/Portfolio_2.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>SIPAPA MAMASA</h4>
                <p>Web</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/Portfolio_3.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>SMTK MAMASA</h4>
                <p>Web</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/Portfolio_4.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>WEB SAFETY BOSOWA</h4>
                <p>Web</p>
                <div class="portfolio-links">
          ...
          <!-- <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/Portfolio_5.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Point Of Sales</h4>
                <p>Web</p>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio/Portfolio_5.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <img src="assets/img/team/marcel.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Marcellino Derry Utomo</h4>
                  <span>DevOps</span>
                </div>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row no-gutters justify-content-center" data-aos="fade-up">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <iframe style="border:0; width: 100%; height: 270px;" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Makassar+(Your%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" frameborder="0" allowfullscreen></iframe>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p>
                Jl. - <br>
                -Poscode-, Makassar<br><br>
                <strong>Phone:</strong> +62 813 4159 1238<br>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>CV. Surya Perkasa</span></strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
